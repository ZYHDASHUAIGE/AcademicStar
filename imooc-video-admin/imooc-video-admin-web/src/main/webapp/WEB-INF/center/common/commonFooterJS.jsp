...
<input type="hidden" id="apiServer" name="apiServer" value="http://10.249.150.16:8081"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://10.249.150.16:8080/mvc"/>
