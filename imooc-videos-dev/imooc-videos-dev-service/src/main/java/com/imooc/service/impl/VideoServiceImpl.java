...
public class VideoServiceImpl implements VideoService {
	...
	public PagedResult getAllVideos(Videos video, Integer isSaveRecord,
		...
		// 保存热搜词记录
		String desc = video.getVideoDesc();  //获取视频描述
	...
	public void userUnLikeVideo(String userId, String videoId, String videoCreaterId) {
		...
		Example example = new Example(UsersLikeVideos.class);  //创建条件
		Criteria criteria = example.createCriteria();  //条件查询
		
		criteria.andEqualTo("userId", userId);  //条件判断 《属性名，值》
