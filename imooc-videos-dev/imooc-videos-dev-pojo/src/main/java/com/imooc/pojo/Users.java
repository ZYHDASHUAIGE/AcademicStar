...
public class Users {
	@ApiModelProperty(hidden=true)  //对用户进行屏蔽
    @Id
    private String id;
     ...
     * 用户名
     */
    @ApiModelProperty(value="用户名",name="username",example="imoocuser",required=true)         //前端传参的注解
    private String username;

    /**
     * 密码
     */
    @ApiModelProperty(value="密码",name="password",example="123456",required=true)  //前端传参的注解
