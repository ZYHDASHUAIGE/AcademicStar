...
public class VideoController {
	...
	public IMoocJSONResult bgmUpload(@RequestParam("file") MultipartFile[] files) throws Exception {
		...
		// 文件保存的命名空间
//		String fileSpace = File.separator + "imooc_videos_dev" + File.separator + "mvc-bgm";   //linux
		String fileSpace = "D:" + File.separator + "imooc_videos_dev" + File.separator + "mvc-bgm";  //windows
		// 保存到数据库中的相对路径
